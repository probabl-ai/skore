...
#
#     $ bash pip-compile.sh <skore|skore-remote-project|skore-local-project> --upgrade
#
...
case "${PACKAGE}" in
    "skore"|"skore-remote-project"|"skore-local-project") ;;
    *)
        >&2 echo "Error: Unknown package: '${PACKAGE}'"
        >&2 echo "Usage: bash pip-compile.sh <skore|skore-remote-project|skore-local-project> [option...]"
        exit 1
        ;;
esac
...
COMBINATIONS[6]='3.13;1.4'
COMBINATIONS[7]='3.13;1.5'
COMBINATIONS[8]='3.13;1.6'
