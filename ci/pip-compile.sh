...
case $1 in
    "--test-requirements")
        ...
        do
            ...
            COMBINATIONS+=("${PACKAGE};test;3.14;1.5")
            COMBINATIONS+=("${PACKAGE};test;3.14;1.6")
            COMBINATIONS+=("${PACKAGE};test;3.14;1.7")
            COMBINATIONS+=("${PACKAGE};test;3.14;1.8")
        done
        ...
        ;;
    "--sphinx-requirements")
        COMBINATIONS+=("skore;sphinx;3.14;1.8")
        shift
        ;;
    *)
