...
import type {
  EstimatorReportPrimaryResults,
  EstimatorReportTabularResult,
} from "@/components/EstimatorReport.vue";
import EstimatorReportMetricFavorability from "@/components/EstimatorReportMetricFavorability.vue";
import FloatingTooltip from "@/components/FloatingTooltip.vue";
import StaticRange from "@/components/StaticRange.vue";
import { isElementOverflowing } from "@/services/utils";

const props = defineProps<EstimatorReportPrimaryResults>();
const currentTabularResultIndex = ref(0);
const currentTabularResult = computed<EstimatorReportTabularResult>(() => {
    ...
    <div class="scalar-results">
      ...
      >
        <FloatingTooltip placement="bottom" :enabled="isNameTooltipEnabled(i)">
          <div class="name">
            {{ result.name }}
            <EstimatorReportMetricFavorability :favorability="result.favorability" />
          </div>
