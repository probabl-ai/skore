...
@mark.parametrize(
    ...
    (
        ...
        param(
            ...
            "image/svg+xml",
            serialize_svg,
            id="ConfusionMatrixSVGTest[estimator]",
        ),
        param(
            ConfusionMatrixDataFrameTest,
            "binary_classification",
        ...
        param(
            ...
            "image/svg+xml",
            serialize_svg,
            id="ConfusionMatrixSVGTrain[estimator]",
        ),
        param(
            ConfusionMatrixDataFrameTrain,
            "binary_classification",
        ...
        param(
            ...
            "image/svg+xml",
            serialize_svg,
            id="ConfusionMatrixSVGTest[cross-validation]",
        ),
        param(
            ConfusionMatrixDataFrameTest,
            "cv_binary_classification",
        ...
        param(
            ...
            "image/svg+xml",
            serialize_svg,
            id="ConfusionMatrixSVGTrain[cross-validation]",
        ),
        param(
            ConfusionMatrixDataFrameTrain,
            "cv_binary_classification",
