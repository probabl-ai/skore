...
report.metrics.add(f2_scorer, name="F2 Score")
...
report.metrics.summarize(
    metric=["Specificity", "F2 Score", "Misclassification Cost"],
).frame()
...
# %%
report.metrics.summarize(metric=["Specificity", "F2 Score"], data_source="both").frame()
...
report.metrics.summarize(metric=["Mean Confidence"]).frame()
