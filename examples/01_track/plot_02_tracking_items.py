...
#
# In the following, we explore skore's :func:`skore.CrossValidationReporter` that natively
# includes tracking.

# %%
# .. _example_track_cv:
# Tracking the results of several runs of :func:`skore.CrossValidationReporter`
# ====================================================================
