...
#
#    * Scikit-learn compatible :func:`skore.CrossValidationReporter` and
...
# .. seealso::
#
#   For more information about the motivation and usage of :func:`skore.CrossValidationReporter`,
