...
from skore.displays.metrics.metrics_summary_display import MetricsSummaryRow
from skore.metrics import Metric, MetricLike
from skore.reports._base import BaseMetricsAccessor, _summarize_report_metrics
...
from skore.utils._index import squeeze_single_column
