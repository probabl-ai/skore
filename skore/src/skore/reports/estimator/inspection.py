...
from skore.displays.inspection.calibration_curve import CalibrationDisplay
from skore.displays.inspection.coefficients import CoefficientsDisplay
from skore.displays.inspection.impurity_decrease import ImpurityDecreaseDisplay
from skore.displays.inspection.permutation_importance import (
    PermutationImportanceDisplay,
)
from skore.metrics import MetricLike
from skore.reports._base import _BaseAccessor
from skore.reports.estimator.report import EstimatorReport
from skore.sklearn.types import DataSource
    ...
    @available_if(
        _check_all_checks(
            [
                ...
                _check_estimator_has_method("predict_proba"),
            ]
        )
    )
