...
from skore.plugins import switch_plt_backend
from skore.plugins.hub.client.client import Client, HUBClient
...
class Project:
    ...
    The class main methods are :func:`~skore.plugins.hub.Project.put`,
    :func:`~skore.plugins.hub.reports.metadata` and
    :func:`~skore.plugins.hub.reports.get`, respectively to insert a key-report pair
