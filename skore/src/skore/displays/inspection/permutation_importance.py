...
from skore.displays.base import BOXPLOT_STYLE, DisplayMixin
from skore.displays.inspection.utils import (
...
from skore.sklearn.types import Aggregate, DataSource, ReportType
from skore.utils._callable import _callable_name
