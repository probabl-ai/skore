...
# [joblib v.1.4.2](https://github.com/joblib/joblib/blob/1.4.2/joblib/hashing.py)
# to allow using any hash function compatible with
# [hashlib's hash object API](https://docs.python.org/3/library/hashlib.html#hash-objects).
