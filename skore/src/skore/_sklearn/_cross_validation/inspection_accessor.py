...
class _InspectionAccessor(_BaseAccessor[CrossValidationReport], DirNamesMixin):
    ...
    def permutation_importance(
        ...
        *,
        ...
        0        test     r2      1  Feature #0           1  0.63...
        1        test     r2      1  Feature #1           1  1.82...
        2        test     r2      1  Feature #2           1  0.01...
        3        test     r2      1  Feature #0           2  0.49...
        4        test     r2      1  Feature #1           2  1.15...
        5        test     r2      1  Feature #2           2  0.01...
        ...
        ... ).frame(aggregate=None)
          data_source                  metric  split     feature  repetition       value
        0        test                      r2      0  Feature #0           1      0.7...
        1        test                      r2      0  Feature #1           1      1.5...
        2        test                      r2      0  Feature #2           1      0.0...
        3        test                      r2      0  Feature #0           2      0.7...
        4        test                      r2      0  Feature #1           2      1.5...
        5        test                      r2      0  Feature #2           2      0.0...
        0        test  neg_mean_squared_error      0  Feature #0           1   3217.2...
        1        test  neg_mean_squared_error      0  Feature #1           1   7156.4...
        2        test  neg_mean_squared_error      0  Feature #2           1     55.1...
        3        test  neg_mean_squared_error      0  Feature #0           2   3175.0...
        4        test  neg_mean_squared_error      0  Feature #1           2   7154.9...
        5        test  neg_mean_squared_error      0  Feature #2           2     73.3...
        0        test                      r2      1  Feature #0           1      0.6...
        1        test                      r2      1  Feature #1           1      1.8...
        2        test                      r2      1  Feature #2           1      0.0...
        3        test                      r2      1  Feature #0           2      0.4...
        4        test                      r2      1  Feature #1           2      1.1...
        5        test                      r2      1  Feature #2           2      0.0...
        0        test  neg_mean_squared_error      1  Feature #0           1   3993.8...
        1        test  neg_mean_squared_error      1  Feature #1           1  11552.5...
        2        test  neg_mean_squared_error      1  Feature #2           1     89.1...
        3        test  neg_mean_squared_error      1  Feature #0           2   3132.0...
        4        test  neg_mean_squared_error      1  Feature #1           2   7294.5...
        5        test  neg_mean_squared_error      1  Feature #2           2     89.5...
        ...
        0        test     r2      0  Feature #0    0.710142   0.00...
        1        test     r2      0  Feature #1    1.589907   0.00...
        2        test     r2      0  Feature #2    0.014270   0.00...
        3        test     r2      1  Feature #0    0.563450   0.09...
        4        test     r2      1  Feature #1    1.490259   0.47...
        5        test     r2      1  Feature #2    0.014130   0.00...
