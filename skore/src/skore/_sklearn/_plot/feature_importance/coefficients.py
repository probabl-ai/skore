<<<<<<< conflict 1 of 1
%%%%%%% diff from: qrsntnvo 93a375ea "chore(skore): Add the feature importance accessor to the API reference (#2315)" (parents of rebased revision)
...
%%%%%%% diff from: rvxokozz b8c2eff5 "Merge branch 'main' into issue-2161" (parents of rebased revision)
...
+++++++ wukowmrv 521278e7 "merge" (rebased revision)
