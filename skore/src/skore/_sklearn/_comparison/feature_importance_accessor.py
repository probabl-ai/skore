...
class _FeatureImportanceAccessor(_BaseAccessor["ComparisonReport"], DirNamesMixin):
    ...
    def coefficients(self) -> CoefficientsDisplay:
        ...
        1   report small alpha  Feature #2      505.5...
        2   report small alpha  Feature #4     -408.5...
        3   report small alpha  Feature #3      298.4...
        4   report small alpha  Feature #1     -238.2...
        5   report small alpha  Feature #5      164.0...
        6   report small alpha   Intercept      151.5...
        7   report small alpha  Feature #7      123.0...
        8   report small alpha  Feature #9       99.4...
        9   report small alpha  Feature #6      -55.1...
        10  report small alpha  Feature #0      -11.6...
        11    report big alpha   Intercept      151.0...
        12    report big alpha  Feature #8        0.6...
        13    report big alpha  Feature #2        0.6...
        14    report big alpha  Feature #7        0.5...
        15    report big alpha  Feature #3        0.5...
        16    report big alpha  Feature #6       -0.4...
        17    report big alpha  Feature #9        0.4...
        18    report big alpha  Feature #4        0.2...
        19    report big alpha  Feature #0        0.2...
        20    report big alpha  Feature #5        0.2...
        21    report big alpha  Feature #1        0.0...
