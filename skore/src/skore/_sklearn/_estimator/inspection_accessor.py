...
class _InspectionAccessor(_BaseAccessor[EstimatorReport], DirNamesMixin):
    ...
    def permutation_importance(
        ...
        *,
        ...
        ...    n_repeats=2,
        ...    seed=0,
        ... ).frame(aggregate=None)  # doctest: +ELLIPSIS
          data_source metric     feature  repetition     value
        0        test     r2  Feature #0           1  ...
        1        test     r2  Feature #1           1  ...
        2        test     r2  Feature #2           1  ...
        3        test     r2  Feature #0           2  ...
        4        test     r2  Feature #1           2  ...
        5        test     r2  Feature #2           2  ...
        ...
        4         test                      r2  Feature #1           2     ...
        5         test                      r2  Feature #2           2     ...
        6         test  neg_mean_squared_error  Feature #0           1  ...
        7         test  neg_mean_squared_error  Feature #1           1  ...
        8         test  neg_mean_squared_error  Feature #2           1  ...
        9         test  neg_mean_squared_error  Feature #0           2  ...
        10        test  neg_mean_squared_error  Feature #1           2  ...
        11        test  neg_mean_squared_error  Feature #2           2  ...

        >>> report.inspection.permutation_importance(
        ...    n_repeats=2,
        ...    seed=0,
        ... ).frame()  # doctest: +ELLIPSIS
