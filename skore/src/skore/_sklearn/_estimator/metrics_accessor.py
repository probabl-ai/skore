...
class _MetricsAccessor(_BaseAccessor[EstimatorReport], DirNamesMixin):
    ...
    def summarize(
        ...
        *,
        ...
        for parsed_metric in parsed_metrics:
            ...
            row = {
                "metric": parsed_metric.verbose_name,
    ...
    def accuracy(
        ...
        *,
        ...
        0.94...
        """
        return cast(float, Accuracy()(report=self._parent, data_source=data_source))
    ...
    def precision(
        ...
        *,
        ...
        0.98...
        """
        return Precision()(report=self._parent, data_source=data_source)
    ...
    def recall(
        ...
        *,
        ...
        0.92...
        """
        return Recall()(report=self._parent, data_source=data_source)
    ...
    def roc_auc(
        ...
        *,
        ...
        0.99...
        """
        return RocAuc()(report=self._parent, data_source=data_source)
    ...
    def log_loss(
        ...
        *,
        ...
        0.11...
        """
        return cast(float, LogLoss()(report=self._parent, data_source=data_source))
    ...
    def r2(
        ...
        *,
        ...
        0.34...
        """
        return R2()(report=self._parent, data_source=data_source)
    ...
    def rmse(
        ...
        *,
        ...
        58.1...
        """
        return Rmse()(report=self._parent, data_source=data_source)
