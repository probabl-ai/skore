...
def test_estimator_report_feature_importance_help(capsys, linear_regression_with_test):
...
def test_estimator_report_feature_importance_repr(linear_regression_with_test):
