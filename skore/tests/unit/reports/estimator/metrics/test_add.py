...
class TestBasicAdd:
    ...
    def test_callable_missing_kwargs(self, binary_classification_report):
        """adding a callable with required params but no kwargs errors."""
        report = binary_classification_report
...
class TestScorerExtraction:
    ...
    def test_extract_metric(self, binary_classification_report):
        """Test that scorer is correctly extracted."""
        report = binary_classification_report
        ...
        report.metrics.add(proba_scorer)
...
class TestMakeMetric:
    ...
    def test_callable_greater_is_better(self):
    ...
    def test_scorer_with_name(self):
    ...
    def test_scorer_extracts_kwargs(self):
