...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("comparison_estimator_reports_regression", ["estimator", "auto", "None"]),
        (
...
def test_valid_subplot_by(pyplot, comparison_estimator_reports_regression):
...
@pytest.mark.parametrize(
    ...
    [
        ("comparison_estimator_reports_binary_classification_different_features", None),
        (
