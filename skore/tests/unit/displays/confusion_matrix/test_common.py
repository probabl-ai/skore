...
def test_threshold_values_are_sorted(fixture_name, request):
...
def test_threshold_values_are_unique(fixture_name, request):
...
def test_plot_multiclass_no_threshold_in_title(pyplot, fixture_name, request):
