...
from skore.plugins.hub.authentication.login import login
from skore.plugins.hub.authentication.uri import URI
from skore.plugins.hub.client.client import Client, HUBClient, __semver
...
class TestClient:
    ...
    def test_request_without_retry(self, monkeypatch, respx_mock):
        ...
        monkeypatch.setattr("skore.plugins.hub.client.client.sleep", sleep)
...
class TestHUBClient:
    ...
    def test_request_with_token(self, monkeypatch, respx_mock):
        monkeypatch.setattr(
            "skore.plugins.hub.authentication.token.open_webbrowser",
            lambda _: True,
        )
    ...
    def test_request_without_package_semver(self, monkeypatch, respx_mock):
        ...
        from skore.plugins.hub.client.client import PACKAGE_SEMVER
    ...
    def test_request_with_package_semver(self, monkeypatch, respx_mock):
        monkeypatch.setenv("SKORE_HUB_API_KEY", "<api-key>")
        monkeypatch.setattr("skore.plugins.hub.client.client.PACKAGE_SEMVER", "1.0.0")
        respx_mock.get(urljoin(URI(), "foo")).mock(Response(200))
        login()
    ...
    def test_jupyterlite(self, monkeypatch):
        ...
        monkeypatch.setattr("skore.plugins.hub.client.client.JUPYTERLITE", True)
