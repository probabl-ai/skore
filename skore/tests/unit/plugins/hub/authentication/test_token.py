...
from skore.plugins.hub.authentication.token import (
    Token,
...
def test_get_oauth_device_code_probe(monkeypatch, respx_mock):
    monkeypatch.setattr("skore.plugins.hub.authentication.token.sleep", lambda _: None)
...
class TestToken:
    ...
    def test_init(self, monkeypatch, respx_mock):
        ...
        monkeypatch.setattr(
            "skore.plugins.hub.authentication.token.open_webbrowser", open_webbrowser
        )
